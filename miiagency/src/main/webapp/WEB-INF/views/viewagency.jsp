                    ...
                    <div class="card-content">
                     ...
                     <div class="form-group">
                       ...
                       <br><br>
						...
						<form:input type="file" name="certificateImage" path="certificateImage" id="certificateImage" aria-invalid="false" class="valid"/><div class="ripple-container"></div></span>
                         </div>  --%>  			 
				...
				<div class="card-content">
					<h4 class="card-title">Bank Details</h4>
                        ...
                        <div class="form-footer text-right">
							...
							<button type="submit" style="margin-top:3.7%" formaction="/miiagency/agency/editAgency" class="btn btn-rose btn-fill">Edit</button>
							<!-- </a> -->
							<!-- <a href="/miiadmin/admin/home"> -->
							<button type="submit"  style="margin-top:3.7%" formaction="/miiagency/agency/home" class="btn btn-rose btn-fill">Back</button>   
	...
	<script type="text/javascript">
  	/* $("#eid").blur(function() {
  		...
  		if(emailId != "")
  		{
  			...
  			$.ajax({
  	  	        type: 'GET',
  	  	        url: "/miiagency/agency/checkEmailId/" + emailId,
  	  	        success: function(data){
  	  	        	//alert(data);
  	  	            if(data=="true")
  	  	            {
  	  	            	$("#eid").val("");
  	  	            	$("#errorMsg").text("Email Id already exists.");    		
  	  	            }
  	  	            else
  	  	          	{
  	  	            	$("#errorMsg").text("");
  	...
  	/* $("#cityId").change(function() {
  	    ...
  	    $.ajax({
  	        type: 'GET',
  	        url: "/miiagency/agency/getAreas/" + cityId,
  	        success: function(data){
