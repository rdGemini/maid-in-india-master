            ...
            <div class="card">
                <form id="RegisterValidation" action="#" method="">
                    ...
                    <div class="card-content">
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-3" style="margin-left:370px; margin-top:-60px;">
                     <div class="form-group label-floating is-empty">
                            <label class="control-label">
                                Date Of Birth
                                <small>*</small>
            		 ...
            		 <div class="form-group label-floating is-empty">
						...
						<input type="file" id="id" aria-invalid="false" class="valid"><div class="ripple-container"></div></span>
                         ...
                         <div class="form-group label-floating is-empty" style = "margin-top:-2%">
                         <label class="control-label">
                         ...
                         <span class="btn btn-round btn-rose btn-file" style="margin-top:3.5%">
						<span class="fileinput-new">Choose File</span>
						<input type="file" id="id" aria-invalid="false" class="valid"><div class="ripple-container"></div></span></div>
            <div class="col-md-6" style="margin-left:48%; margin-top:-33%">
			<div class="card">
				<div class="card-header card-header-icon" data-background-color="rose">
