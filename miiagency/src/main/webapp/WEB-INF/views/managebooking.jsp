            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <!-- <button type="button" rel="tooltip" class="btn btn-info btn-simple" rel="tooltip" data-placement="bottom" title="Add" style="margin-left:91%; margin-top:-4%">
                             <a href="/miiagency/agency/registerAgency"><i class="material-icons icon-image-preview" style="color:#ec407a; font-size:50px">add_box</i>
                                        </button></a>       
                     --><div class="toolbar">
