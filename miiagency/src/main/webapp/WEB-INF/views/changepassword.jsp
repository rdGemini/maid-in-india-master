		...
		<div class="main-panel">
			...
			<div class="card">
				...
				<div class="card-content">
					...
					<form:form method="post" action="/miiagency/agency/change" modelAttribute="cpass">
	                    ...
	                    <div class="col-lg-11 col-md-9 col-sm-3">
	                        <div class="input-group">
                                        ...
                                        <input type="password" required="true" id="registerPassword" placeholder="New Password" class="form-control" path="npassword" name="npassword" />
                                        <span class="material-input" id="errPass" style="color:red;"></span>
                        </div>
                        </div></div><br><br>
                        <div class="form-group label-floating is-empty">
	                    <div class="col-lg-11 col-md-9 col-sm-3">
	                        <div class="input-group">
                                        ...
                                        <input type="password" required="true" id="registerPasswordConfirmation" placeholder="Confirm Password" class="form-control" path="cpassword" name="cpassword" />
