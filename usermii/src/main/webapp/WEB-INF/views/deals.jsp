...
<body>
	...
	<main class="page-main"  style="background-image:url('/usermii/resources/images/bedroom-cleaningres2.jpg'); background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%">
		...
		<div class="block">
			<div class="container">
				<h2 class="text-center h-lg h-decor">Grab your favourite Deal</h2>
					...
					<div class="col-sm-4">
						<div class="news-prw" style="border-radius: 10px;text-align: center;">
							<div class="news-prw-image">
									<img src="/usermii/resources/images/${deal.photo}" alt="" style="border-radius: 10px;">
									<!-- <span><i class="icon-link"></i></span> -->	
							</div>
							<div id="code1" style="visibility: hidden; height:0px; width:0px">${deal.code}</div>
							<div class="news-prw-date">Valid till ${deal.endDuration}</div>
