				...
				<div class="row">				
					<div class="col-lg-5">
						<div class="order-form-box"  style="background-color:#fff; border-radius:5%">
							<form method="post" 
								modelAttribute="password" action="/usermii/user/changepass1">
								<!-- <h3>Login</h3>
								...
								<div class="row">
									<div class="col-sm-10">
											<input type="password" class="input-custom input-custom--sm input-full" name="password" path="password" placeholder="Enter Password*" style="margin-left:10%; border:none; border-bottom: 1px solid #d7dbdf; border-radius: 0px">
									</div>
								</div> -->
