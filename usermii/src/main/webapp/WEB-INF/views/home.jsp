			...
			<div id="mainSliderWrapper">
				...
				<div id="mainSlider">
					<div class="slide mask">
						<div class="img--holder" style="background-image: url(/usermii/resources/images/slider/slide-1.jpg);"></div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
									<div class="container">
									 	<h2 data-animation="zoomIn" data-animation-delay="1s">So Fresh & So Clean...</h2>
										<h3 data-animation="zoomIn" data-animation-delay="2s">We Promise!</h3>
										<a href="/usermii/user/orderform" class="btn" data-animation="fadeInUp" data-animation-delay="2s">Free Estimate</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="slide mask">
						<div class="img--holder" style="background-image: url(/usermii/resources/images/slider/slide-2.jpg);"></div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
									<div class="container">
					...
					<div class="slide mask">
						<div class="img--holder" style="background-image: url(/usermii/resources/images/slider/slide-3.jpg);"></div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
									<div class="container">
			...
			<div class="container">
				<div class="row service-house-row">
					<div class="col-lg-5 inset-pad">
						...
						<div class="divider-sm"></div>
						<a href="/usermii/user/orderform" class="btn btn-lg animation" data-animation="tada"><i class="icon-calc"></i>Calculate now</a>
					</div>
					<div class="col-lg-7">
