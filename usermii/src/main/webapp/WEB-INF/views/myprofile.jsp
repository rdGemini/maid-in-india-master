...
<body>
	...
	<main class="page-main"  style="background-image:url('/usermii/resources/images/block-bg-5.jpg'); background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%; position:relative;z-index: 1">
		...
		<!-- //Breadcrumbs Block -->
		<div class="block">
			<h2 class="text-center h-lg h-decor" style="color:#fff">My Profile</h2><br><br>
				...
				<div class="row">				
					<div class="col-lg-5">
						<div class="order-form-box"  style="background-color:#fff; border-radius:5%;  background-color: white;">
							<form:form method="post" action="/usermii/user/editProfile" modelAttribute="view" enctype="multipart/form-data">
...
<input type="file" id="my_file" style="display: none;" />
								...
								<form:input type="hidden" path="password" id="password"/>
								 <div class="row">
									<div class="col-sm-10">
										<form:input type="text" class="input-custom input-full" name="name" path="name" placeholder="Name*" style="margin-left:10%; margin-top:5%;border:none;
			...
			border-bottom: 1px solid #d7dbdf;border-radius: 0px;" readonly="true"/>
								...
								<div class="text-left">
									<button type="submit" formaction="/usermii/user/editProfile" class="btn btn-wide" style="background-color: #00bcd4; min-width:100px">Edit</button>
								</div>
								<div class="text-right">
									<button type="submit" formaction="/usermii/user/deleteUser" class="btn btn-wide" style="background-color: #00bcd4; min-width:100px; margin-top:-12.3%">Delete</button>
								</div>
