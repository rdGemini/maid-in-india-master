...
<%@page import="com.mii.util.PaytmConstants"%>
...
parameters.put("CALLBACK_URL", "/user/pgResponse");
//parameters.put("CALLBACK_URL", "http://localhost:8081/usermii/user/pgResponse");
//http://localhost:8080/usermii/pgResponse.jsp
//http://localhost:8081/usermii/user/bookingdetails/118
