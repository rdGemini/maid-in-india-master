...
<body>
	...
	<main class="page-main"  style="background-image:url('/usermii/resources/images/block-bg-5.jpg'); background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%">
		...
		<!-- //Breadcrumbs Block -->
		<div class="block">
			<h2 class="text-center h-lg h-decor" style="color:#fff">Registration</h2>
				...
				<div class="row">				
					<div class="col-lg-5">
						<div class="order-form-box"  style="background-color:#fff; border-radius:5%">
							<form method="post" 
								modelAttribute="cpass" action="/usermii/user/checkOtp">
								<!-- <h3>Login</h3>
								...
								<div class="row">
									<div class="col-sm-10">
										<input type="text" required="true" class="input-custom input-custom--sm input-full" name="otp" path="otp" placeholder="Enter OTP*" style="margin-left:10%; border:none; border-bottom: 1px solid #d7dbdf; border-radius: 0px;">
									</div>
								</div>
