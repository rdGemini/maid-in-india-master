				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="order-form-box" style="background-color:#fff; border-radius:1%">
								...
								<%--<div class="row">
									<div class="col-sm-8">
										<form:input type="text" id="" class="input-custom input-custom--sm input-full" placeholder="Apply Promo Code" name="dealCode" path="dealCode" style="border:none; border-bottom: 1px solid #d7dbdf; border-radius: 0px;"/>
									</div>
									<div class="col-sm-4">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<h6 style="margin-top:10px;">&#8377; ${bookingdet.amount}</h6>	
									</div>
								</div><br>
