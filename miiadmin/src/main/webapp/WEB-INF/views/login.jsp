...
<head>
    	...
    	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="/miiadmin/resources/img/apple-icon.png" />
	<link rel="icon" type="image/png" href="/miiadmin/resources/img/favicon.png" />
    ...
    <meta itemprop="image" content="/miiadmin/s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
    ...
    <meta name="twitter:image" content="/miiadmin/s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
	...
	<!-- Bootstrap core CSS     -->
	<link href="/miiadmin/resources/css/bootstrap.min.css" rel="stylesheet" />
	


	<!--  Material Dashboard CSS    -->
	<link href="/miiadmin/resources/css/material-dashboard98f3.css?v=1.3.0" rel="stylesheet"/>

	<!--  CSS for Demo Purpose, don't include it in your project     -->
	<link href="/miiadmin/resources/css/demo.css" rel="stylesheet" />

	
	<!--     Fonts and icons     -->
	<link href="/miiadmin/resources/maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet">
    ...
    '/miiadmin/resources/www.googletagmanager.com/gtm5445.html?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <img src="/miiadmin/resources/img/maid.png" style="height:125px; width:100px; margin-top:-40px">
            <img src="/miiadmin/resources/img/text.png" style="height:100px; width:230px; margin-left:70px; margin-top:-115px; margin-bottom:-30px">
            </a>
        </div>
    ...
    <div class="wrapper wrapper-full-page">
            <div class="full-page login-page" filter-color="black" data-image="/miiadmin/resources/img/login.jpeg">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <%-- <c:forEach items="${admins}" var="admin"> --%>
                        <form method="post" action="/miiadmin/admin/loggingIn" modelAttribute="log">
                            <div class="card card-login card-hidden">
                                ...
                                <div class="footer text-center">
									...
									<br>
									<a href="/miiadmin/admin/forgotPassword"><label class="control-label" style="color:#ec407a">Forgot Password ?</label></a>
                                </div>
                            </div>
                        </form>
                        <!-- </c:forEach> -->
...
<script src="/miiadmin/resources/cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
...
document,'script','/miiadmin/resources/connect.facebook.net/en_US/fbevents.js');
