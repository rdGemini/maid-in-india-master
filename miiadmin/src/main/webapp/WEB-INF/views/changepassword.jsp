		...
		<div class="main-panel">
			...
			<div class="card">
				...
				<div class="card-content">
					...
					<form:form method="post" action="/miiadmin/admin/change" modelAttribute="cpass">
	                    ...
	                    <div class="input-group">
                                        ...
                                        <form:input type="password" id="oldPass" placeholder="Old Password" class="form-control" path="password" name="password" required="true"/>
                                        <span class="material-input" id="errOPass" style="color:red;" required="true"></span>
                        </div>
	                    </div></div><br><br>
	                    <div class="form-group label-floating is-empty">
	                    <div class="col-lg-11 col-md-9 col-sm-3">
	                        <div class="input-group">
                                        ...
                                        <span class="material-input" id="errPass" style="color:red;" required="true"></span>
                        </div>
                        </div></div><br><br>
                        <div class="form-group label-floating is-empty">
	                    <div class="col-lg-11 col-md-9 col-sm-3">
	                        <div class="input-group">
                                        ...
                                        <input type="password" id="registerPasswordConfirmation" placeholder="Confirm Password" class="form-control" path="cpassword" name="cpassword" required="true"/>
                                        <span class="material-input" id="errCPass" style="color:red;"></span>
                        </div>
                        </div></div><br><br>
                        <%if(request.getParameter("errorMsg") != null){ %>
                                <div style="color: red;"><%= request.getParameter("errorMsg") %></div>
...
$("#oldPass").blur(function() 
		{
			...
			if(pass == "")
				$("#errOPass").text("Please enter old password!!");
			else
				$("#errOPass").text("");
		});
