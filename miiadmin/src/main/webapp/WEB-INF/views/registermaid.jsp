                  		...
                  		<div class="fileinput fileinput-new text-center" data-provides="fileinput" style="margin-top:10px;margin-left:25px">
								<div class="fileinput-new thumbnail img-circle">
									<c:choose>
												<c:when test="${edit}">
													<img
													src="/miiadmin/resources/images/maid/profilePicture/${register.profilePicture}"
					...
					<h4 class="card-title">Bank Details</h4>
                        ...
                        <div class="form-footer text-right">
                            <div class="checkbox pull-left">
                                <label>
                                    <input type="checkbox" id="myCheck" onClick='checkButton()' name="optionsCheckboxes" required="true" aria-required="true" checked="checked"></span>
											...
											<c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/miiadmin/maid/updateMaid"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
														value="Register" formaction="/miiadmin/maid/addMaid" />
												</c:otherwise>
											</c:choose>               
                        </div>
                    </div>
	...
	<script type="text/javascript">
  	$("#eid").blur(function() {
  		...
  		else if(emailId != "")
  		{
  			...
  			$.ajax({
  	  	        type: 'GET',
  	  	        url: "/miiadmin/maid/checkEmailId/" + emailId,
