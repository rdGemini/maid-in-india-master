			...
			<div class="card">
				...
				<div class="card-content">
					...
					<form:form id="RegisterValidation" method="post" modelAttribute="register">
						...
						<c:choose>
							<c:when test="${edit}">
								<input type="submit" class="btn btn-rose btn-fill" formaction="/miiadmin/state/updateState" value="Update" style="margin-top:-5%;" />
							</c:when>
							<c:otherwise>
								<input type="submit" class="btn btn-rose btn-fill" formaction="/miiadmin/state/addState" value="Submit" style="margin-top:-5%;"/>
							</c:otherwise>	
						</c:choose>			              
