  ...
  <!-- End Google Tag Manager (noscript) -->
				...
				<div class="card-content">
	                ...
	                <div class="form-group">
	                   ...
	                   <form:select class="selectpicker"  path="cityId" name="cityId" id="citiesByState"
	                    ...
	                    <form:input type="text" id="aname" name="name" path="name" class="form-control" />
	                    <span class="material-input"></span></div></div><br><br><br><br>
	                    <c:choose>
							<c:when test="${edit}">
								<input type="submit" class="btn btn-rose btn-fill" formaction="/miiadmin/area/updateArea" value="Update" style="margin-left:50%;margin-top:-10%;" />
							</c:when>
							<c:otherwise>
								<input type="submit" class="btn btn-rose btn-fill" formaction="/miiadmin/area/addArea" value="Submit" style="margin-left:50%; margin-top:-10%;"/>
							</c:otherwise>	
						</c:choose>		  
	...
	<script type="text/javascript">
  	$("#stateId").change(function() {
  	    ...
  	    $.ajax({
  	        type: 'GET',
  	        url: "/miiadmin/area/getCities/" + stateId,
  	        ...
  	        //	 $("#citiesByState").html(data).selectpicker('refresh');
  	          ...
  	          //$('#citiesByState').em
  	             ...
  	             for(var i=0; i<data.length; i++){
  	            	// alert("hi");		
  	             	//alert(data[i].name);
  	                option = option + "<option value='"+data[i].cityId+"'>"+data[i].name+"</option>";	            }
