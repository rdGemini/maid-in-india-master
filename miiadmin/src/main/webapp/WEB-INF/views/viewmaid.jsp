                    ...
                    <div class="card-content">
						 ...
						 <form:input type="hidden" path="password" id="password"/>
                  		<div class="fileinput fileinput-new text-center" data-provides="fileinput" style="margin-top:10px;margin-left:25px">
								<div class="fileinput-new thumbnail img-circle">
									<img src="/miiadmin/resources/images/maid/profilePicture/${maiddet.profilePicture}" class="picture-src" id="wizardPicturePreview" title=""/>
								</div>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3" style="margin-left:5%; margin-top:-5%">
									...
									data-style="btn btn-primary btn-round" title="City"
                        ...
                        <form:select class="selectpicker" name="areaId" path="areaId" id="areasByCity"
									data-style="btn btn-primary btn-round" title="Area"
									 data-size="7" tabindex="-98" style="background-color:#ec407a" disabled="true">
				...
				<div class="card-content">
					<h4 class="card-title">Bank Details</h4>
                        ...
                        <div class="form-footer text-right">
							...
							<button type="submit" formaction="/miiadmin/maid/editMaid/${maiddet.maidId}" class="btn btn-rose btn-fill">Edit</button>
							<!-- </a> -->
							<!-- <a href="/miiadmin/admin/home"> -->
							<button type="submit" formaction="/miiadmin/maid/maidList" class="btn btn-rose btn-fill">Back</button>
