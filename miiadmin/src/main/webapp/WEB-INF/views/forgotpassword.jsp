            ...
            <div class="container">
                <div class="row">
                    ...
                    <c:forEach items="${admins}" var="admin">
                        <form method="post" action="/miiadmin/admin/getPassword" modelAttribute="password">
                                ...
                                <div class="card-content">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="email" required="true" name="emailId" path="emailId" ng-model="emailid" class="form-control"/>
                                        </div>
