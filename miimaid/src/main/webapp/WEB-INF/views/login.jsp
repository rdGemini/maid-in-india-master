...
<head>
    	...
    	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="/miimaid/resources/img/apple-icon.png" />
	<link rel="icon" type="image/png" href="/miimaid/resources/img/favicon.png" />
    ...
    <!--  Social tags      -->
    <meta name="keywords" content="material dashboard, bootstrap material maid, bootstrap material dashboard, material design maid, material design, creative tim, html dashboard, html css dashboard, web dashboard, freebie, free bootstrap dashboard, css3 dashboard, bootstrap maid, bootstrap dashboard, frontend, responsive bootstrap dashboard, premiu material design maid">
    ...
    <meta itemprop="image" content="/miimaid/s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
    ...
    <meta name="twitter:image" content="/miimaid/s3.amazonaws.com/creativetim_bucket/products/51/opt_mdp_thumbnail.jpg">
	...
	<!-- Bootstrap core CSS     -->
	<link href="/miimaid/resources/css/bootstrap.min.css" rel="stylesheet" />
	


	<!--  Material Dashboard CSS    -->
	<link href="/miimaid/resources/css/material-dashboard98f3.css?v=1.3.0" rel="stylesheet"/>

	<!--  CSS for Demo Purpose, don't include it in your project     -->
	<link href="/miimaid/resources/css/demo.css" rel="stylesheet" />

	
	<!--     Fonts and icons     -->
	<link href="/miimaid/resources/maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet">
    ...
    '/miimaid/resources/www.googletagmanager.com/gtm5445.html?id='+i+dl;f.parentNode.insertBefore(j,f);
...
<body class="off-canvas-sidebar">
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="wrapper wrapper-full-page">
            <div class="full-page login-page" filter-color="black" data-image="/miimaid/resources/img/login.jpeg">
        <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                    <%-- <c:forEach items="${maids}" var="maid"> --%>
                        <form method="post" action="/miimaid/maid/loggingIn" modelAttribute="log">
                            <div class="card card-login card-hidden">
                                ...
                                <div class="footer text-center">
									...
									<br>
									<label class="control-label" style="color:#000000">No Account?&nbsp;&nbsp; </label><a href="/miimaid/maid/registerMaid"><label class="control-label" style="color:#ec407a">Create one</label></a><br>
									<a href="/miimaid/maid/forgotPassword"><label class="control-label" style="color:#ec407a">Forgot Password ?</label></a>
