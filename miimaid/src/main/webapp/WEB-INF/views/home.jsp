		...
		<div class="card card-product" >
			...
			<div class="card-content">
				...
				<div class="card-description">
					<a href="/miimaid/maid/editMaid" class="btn btn-fill btn-rose">Edit</a>
				</div>
			</div>
	...
	<div class="col-md-4">
		<div class="card card-product">
			...
			<div class="card-content" >
				...
				<div class="card-description">
					<a href="/miimaid/maid/viewMaid" class="btn btn-fill btn-rose">View</a>
				</div>
			</div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <!-- <button type="button" rel="tooltip" class="btn btn-info btn-simple" rel="tooltip" data-placement="bottom" title="Add" style="margin-left:91%; margin-top:-4%">
                             <a href="/miimaid/agency/registerAgency"><i class="material-icons icon-image-preview" style="color:#ec407a; font-size:50px">add_box</i>
                                        </button></a>       
                     --><div class="toolbar">
                    ...
                    <div class="material-datatables">
                        ...
                        <input type="search" class="form-control" placeholder="Search records" aria-controls="datatables"><span class="material-input"></span></label></div></div></div><div class="row"><div class="col-sm-12"><table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                            <thead>
                                <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 150px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Booking No.</th>
                                <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 150px;" aria-label="Position: activate to sort column ascending">User</th>
                                <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 150px;" aria-label="Office: activate to sort column ascending">Maid</th>
                                </tr>
                            </thead>
                            <!-- <tfoot>
                            ...
                            <tr role="row" class="odd">
                                    <td tabindex="0" class="sorting_1">${theCount.count}</td>
                                    <td>${booking.uname}</td>
                                    <td>${booking.mname}</td>
                                    <td class="td-actions text-right">
                                    	<a href="/miimaid/booking/viewBooking/${booking.bookingId}">
                                        <button type="button" rel="tooltip" class="btn btn-info btn-simple" rel="tooltip" data-placement="bottom" title="View">
                                            <i class="material-icons">person</i>
                                        </button></a>
                                       <%--  <a href="/miimaid/booking/editBooking/${booking.bookingId}">
