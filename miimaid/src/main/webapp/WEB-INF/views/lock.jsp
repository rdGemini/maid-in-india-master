  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <img src="/miimaid/maid.png" style="height:125px; width:100px; margin-top:-40px">
            <img src="/miimaid/text.png" style="height:100px; width:230px; margin-left:70px; margin-top:-115px; margin-bottom:-30px">
            </a>
        </div>
    ...
    <div class="wrapper wrapper-full-page">
            <div class="full-page lock-page" filter-color="black" data-image="/miimaid/resources/img/lock.jpg">
            ...
            <form method="#" action="home.jsp">
                <div class="card card-profile card-hidden">
                    <div class="card-avatar">
                        <a href="#pablo">
                            <img class="avatar" src="/miimaid/resources/img/faces/avatar.jpg" alt="...">
                        </a>
                    </div>
